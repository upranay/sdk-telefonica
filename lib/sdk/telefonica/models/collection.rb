...
module Sdk
  module Telefonica
    class Collection < Fog::Collection
      ...
      def all(options = {})
        raise Sdk::Telefonica::Errors::InterfaceNotImplemented.new('Method :all is not implemented')
      end
      ...
      def get(uuid)
        raise Sdk::Telefonica::Errors::InterfaceNotImplemented.new('Method :get is not implemented')
      end
      ...
      def destroy(uuid)
        raise Sdk::Telefonica::Errors::InterfaceNotImplemented.new('Method :destroy is not implemented')
      end
    end
  end
end
